...
class OrderServiceTest {
    ...
    void getOrdersBetweenDatesTest() {
        List<Order> result = orderService.getOrdersBetweenDates(LocalDate.of(2021, 6, 6),
                LocalDate.of(2021, 6, 8));

        assertEquals(3, result.size());
        assertEquals(LocalDate.of(2021,6,7), result.get(0).getOrderDate());
        assertEquals(LocalDate.of(2021,6,7), result.get(1).getOrderDate());
        assertEquals(LocalDate.of(2021,6,7), result.get(2).getOrderDate());
    }
}